/*
    ...
    *DOM객체*
        ...
        - document 객체내 속성과 함수는 무엇이 있나요? 다양하다
            ...
            2. document.querySelector('선택자')     : HTML에 지정한 선택자의 마크업을 객체로 반환 함수. [ 객체 ]
            3. document.querySelectorAll('선택자')  : HTML에 지정한 선택자의 모든 마크업을 객체타입으로 반환 점수 [ 배열 ]
                - 선택자( css 동일 ) : 1. 마크업 2. .클래스명 3. #id명 4. > 자식 5. 띄어쓰기 자손 등등
        - document : 현재 JS가 위치한 HTML의 객체화( HTML 조작 )
        ...
        - 요소(마크업) 객체 주요 속성/함수 , 마크업들의 속성들을 JS에서도 접근이 가능하다.
            ...
            2. .innerHTML : 지정된 마크업의 시작마크업과 끝마크업의 > 사이 < 가 inner , 마크업 사이에 HTML 호출/대입
                ...
                - 사용불가능한 요소 : input/? , <select/> , <textarea/> 등등
                <호출> document.querySelector('선택자').inenerHTML      [ 문자열 ]
...
// [2]
console.log( document.querySelector('title') ); // <title>마크업을 JS의 객체타입으로 반환[ 객체 ]
console.log( document.querySelector('body') ); // <title>마크업을 JS의 객체타입으로 반환[ 객체 ]
